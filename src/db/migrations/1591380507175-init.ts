...
export class init1591380507175 implements MigrationInterface {
    name = 'init1591380507175'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "fees" ("timestamp" integer PRIMARY KEY NOT NULL, "total" integer NOT NULL, "raw" text NOT NULL)`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "fees"`, undefined);
    }
