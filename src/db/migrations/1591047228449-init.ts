...
export class init1591047228449 implements MigrationInterface {
    name = 'init1591047228449'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "utxos" ("txid" text PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime, "amount" integer NOT NULL, "raw_tx" text NOT NULL)`, undefined);
    }
